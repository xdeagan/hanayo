...
func sessionInitializer() func(c *gin.Context) {
	return func(c *gin.Context) {
		...
		if addBannedMessage {
			addMessage(c, warningMessage{T(c, "You have been automatically logged out of your account because your account has either been banned or locked. Should you believe this is a mistake, you can contact an Mikoto Admin. Mikoto does not accept regular appeals.")})
		}
		if passwordChanged {
