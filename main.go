...
func main() {
	...
	var configDefaults = map[*string]string{
		...
		&config.AvatarURL:        "https://a.mikoto.ga",
		&config.BaseURL:          "https://mikoto.ga",
		&config.BanchoAPI:        "https://c.mikoto.ga",
		...
		&config.MainRippleFolder: "/home/root",
		&config.MailgunFrom:      `"Mikoto" <noreply@mikoto.ga>`,
	}
...
Perhaps report this to a Mikoto developer?
